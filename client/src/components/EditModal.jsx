...
import { X, Lock, Eye, EyeOff, Clock } from "lucide-react";
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="border-t border-[#1E1E2E] pt-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              {link.password && (
                <span className="text-xs bg-[#6E56CF]/20 text-[#6E56CF] px-2 py-0.5 rounded-full">Active</span>
              )}
            </div>
            <p className="text-[#888899] text-xs mb-3">
              {link.password
                ? "This link is password protected. Set a new password or leave empty to remove."
                : "Add a password to protect this link."}
            </p>
